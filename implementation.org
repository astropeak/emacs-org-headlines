...
(defvar eoh-home-dir (format "%s/%s" (getenv "HOME") ".emacs-org-headlines") "the data dir for the eoh applicaton. All generated headlines will be saved in this dir")
...
** add files
   ...
   (defun eoh-add-file-single (file)
     ...
     (interactive "fFile: ")
     (push (replace-regexp-in-string eoh-base-dir "" file) eoh-files)
     )
   #+END_SRC
